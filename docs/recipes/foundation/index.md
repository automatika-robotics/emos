...
:::{grid-item-card} {material-regular}`chat;1.2em;sd-text-primary` Conversational Agent
...
:::{grid-item-card} {material-regular}`smart_toy;1.2em;sd-text-primary` Complete Agent
:link: complete-agent
:link-type: doc
