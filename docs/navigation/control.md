...
:::{tip}
Provide a `vision_detections` input topic to activate the vision-based target following action server. See the [Vision Tracking tutorial](../recipes/navigation/vision-tracking-rgb.md) for details.
:::
